...
abstract class EPTZ12 implements DatabaseInterface
{
    use DatabaseTrait;
     ...
     * @property string
     */
    const NOM = 'Installation d\'une PAC géothermique à capteur fluide frigorigène, de type eau glycolée/eau 
                ou de type eau/eau avec programmateur de chauffage';
